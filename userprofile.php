			...
			while($rowUsers=mysqli_fetch_assoc($userDetails)){
				...
				echo'<div id="userProfileDetailsDiv" style="display:none">
					<div class="postDiv" style="padding:30px 10px;min-height:500px">';
						echo'<div class="profileDetail">Username: <span class="actualDetail">'.$currentUsername.'</span></div>
							<div class="profileDetail">Full Name: <span class="actualDetail">'.getFriendsFullName($currentUsername,$conn).'</span></div>';
							if(isset($_SESSION['id'])){
								echo'<div class="profileDetail">E-mail: <span class="actualDetail">'.strtolower($currentEmail).'</span></div>
									<div class="profileDetail">Phone: <span class="actualDetail">'.$currentPhone.'</span></div>';
							}
					echo'</div>
				</div>';
